...
-- CASCADE borra de golpe lo que dependa de la función (la vista v_serie_30d),
-- para que no falle con "other objects depend on it". Ambas se recrean después.
drop function if exists serie_periodo(date, date) cascade;
